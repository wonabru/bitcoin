...
public:
    ...
    {
        char ret[32+256+256+32+33];
        ret[0]='\0';
        strcat(ret,byte_to_binary((unsigned)this->nVersion));
        strcat(ret,byte_to_binary(this->hashPrevBlock));
        strcat(ret,byte_to_binary(this->hashMerkleRoot));
        strcat(ret,byte_to_binary((unsigned)this->nTime));
        strcat(ret,byte_to_binary((unsigned)this->nBits));
        return std::string(ret);
    }

    void printBits() const
    {
        printf("0xffffffff: %s\n",byte_to_binary((int)0xffffffff));
        printf("0xffffffff: %s\n",byte_to_binary((unsigned int)0xffffffff));
        printf("uint256 0xffffffff: %s\n",byte_to_binary((uint256)0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff));
        printf("nVersion: %s\n",byte_to_binary(this->nVersion));
        printf("hashPrevBlock: %s\n",byte_to_binary(this->hashPrevBlock));
        printf("hashMerkleRoot: %s\n",byte_to_binary(this->hashMerkleRoot));
        printf("nTime: %s\n",byte_to_binary(this->nTime));
        printf("nBits: %s\n",byte_to_binary(this->nBits));
        printf("nNonce: %s\n",byte_to_binary(this->nNonce));
    }
...
public:
    ...
    void printBits() const
    {
        printf("0xffffffff = ",byte_to_binary((unsigned int)0xffffffff));
        printf("0xffffffff = ",byte_to_binary((int)0xffffffff));
        printf("(uint256)0xffffffff = ",byte_to_binary((uint256)0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff));
        printf("nVersion: %s\n",byte_to_binary(this->nVersion));
        printf("hashPrevBlock: %s\n",byte_to_binary(this->hashPrev));
        printf("hashMerkleRoot: %s\n",byte_to_binary(this->hashMerkleRoot));
        printf("nTime: %s\n",byte_to_binary(this->nTime));
        printf("nBits: %s\n",byte_to_binary(this->nBits));
        printf("nNonce: %s\n",byte_to_binary(this->nNonce));
